      ...
      >
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div>
              <h4 className="text-sm font-medium text-white/40 mb-1">ID</h4>
