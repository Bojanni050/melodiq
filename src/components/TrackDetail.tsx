...
export default function TrackDetail({ track, onClose, onPlay, onDownload }: TrackDetailProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" onClick={onClose}>
      ...
      >
        ...
        {/* Artwork placeholder */}
        <div className="aspect-square bg-gradient-to-br from-primary-500/20 to-purple-500/20 flex items-center justify-center">
