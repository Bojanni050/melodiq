            ...
            <div className="flex items-center gap-3">
              <div className="h-14 w-14 shrink-0 overflow-hidden rounded-lg bg-white/8 flex items-center justify-center">
                {coverPreview ? (
                  <?xml encoding="UTF-8"?>
<?xml encoding="UTF-8"?>
<img loading="lazy" loading="lazy" src={coverPreview} alt="" className="h-full w-full object-cover" />
                ) : track.coverUrl ? (
                  <?xml encoding="UTF-8"?>
<?xml encoding="UTF-8"?>
<img loading="lazy" loading="lazy" src={track.coverUrl} alt="" className="h-full w-full object-cover" />
                ) : (
