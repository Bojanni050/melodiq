                ...
                <div className="space-y-1">
                  ...
                  <div className="mt-3 inline-flex items-center rounded-full border border-white/10 bg-white/5 p-1">
                    ...
                    <button
                      ...
                      className={`h-8 rounded-full px-3 text-sm font-medium transition-colors ${view === "songs" && !selectedPlaylist && !selectedWorkspace ? "bg-white text-black" : "text-white/60 hover:text-white"}`}
                    >
                      Tracks
                    </button>
                    ...
                    <button
                      ...
                      className={`h-8 rounded-full px-3 text-sm font-medium transition-colors ${(view === "workspaces" || !!selectedWorkspace) && !selectedPlaylist ? "bg-white/15 text-white" : "text-white/60 hover:text-white"}`}
                    >
                      Workspaces
                    </button>
                    <div className={`flex items-center overflow-hidden transition-all duration-200 ${selectedWorkspace ? "max-w-[180px] opacity-100" : "max-w-0 opacity-0"}`}>
                      ...
                      <button
                        ...
                        className={`h-8 rounded-full px-3 text-sm font-medium whitespace-nowrap transition-colors ${view === "songs" && !!selectedWorkspace ? "bg-white text-black" : "text-white/60 hover:text-white"}`}
                      >
                        ...
                        >
                          ...
                          {editingDescriptionPlaylistId === playlist.id ? (
                            ...
                            <button
                              ...
                              className="mx-4 mb-2 block w-[calc(100%-2rem)] text-left text-sm text-white/50 hover:text-white/80 transition-colors line-clamp-2"
                            >
                              {playlist.description}
                            </button>
                          ) : null}
                      ...
                      return (
                        <div key={workspace.id} className="group flex items-center gap-4 rounded-2xl border border-white/8 bg-[#0f1017] px-4 py-3 transition-colors hover:bg-white/4">
                          ...
                          <div className="flex items-center gap-3 shrink-0">
                            <button type="button" onClick={() => openWorkspace(workspace.id)} className="text-sm text-white/50 transition-colors hover:text-white">
                              Open
                            </button>
                            {workspace.id !== DEFAULT_WORKSPACE_ID && (
                              <button
                                ...
                                className="text-sm text-white/30 transition-colors hover:text-red-400"
                              >
                                Delete
                              </button>
                            )}
