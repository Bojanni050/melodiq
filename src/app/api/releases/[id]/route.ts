...
export async function PATCH(
  ...
  try {
    ...
    if (action === "update-details") {
      ...
      const writerName = typeof body?.writerName === "string" ? body.writerName.trim().slice(0, 255) || null : undefined;
      const composerName = typeof body?.composerName === "string" ? body.composerName.trim().slice(0, 255) || null : undefined;
      ...
      if (writerName !== undefined) updates.writerName = writerName;
      if (composerName !== undefined) updates.composerName = composerName;
